...
- [4. Project Details](#4-project-details)
  ...
  - [4.4 Dashboard development](#44-dashboard-development)
...
Zwerfinator's primary goal is to make the country litter-free based on data. He releases periodic reports and runs targeted campaigns, such as demonstrating how the newly introduced national policy for deposits on soda cans influences producers to use alternative packaging that bypasses this obligation and is more harmful to the environment.
...
- The increase was most significant in the 3th quarter of 2022.
...
After data preparation and cleaning, I created the data model and multiple measures and dynamic tables for the dashboard to support multiple year linecharts and tables when a year filter is applied.
...
- I gained experience in successfully implementing Python scripts in Power Query with the use of parameters.
- I became proficient in working with geodata and the transformation of geospatial information using tools like Geopandas.
...
- ![Data Model](https://github.com/NdeWinter/dashboard-duel-zwerfinator/raw/main/Screenshots/Datamodel.png)
